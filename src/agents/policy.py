...
RAG-based retrieval of synthetic demo policies (Terms of Use, Code of Conduct,
refund policies) and compliance evaluation via LLM.

All policies referenced by this agent are synthetic hackathon demo data and do
not represent official Ryde records or policies.
"""
import json
import logging
...
class PolicyAgent:
    ...
    async def evaluate_compliance(self, context: DisputeContext) -> dict:
        ...
        system_prompt = (
            ...
            "dispute resolution system. The policies provided are SYNTHETIC "
            "HACKATHON DEMO policies and do not represent any official company "
            "policies.\n\n"
